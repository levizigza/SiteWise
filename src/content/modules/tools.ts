...
export const tools: TrainingModule = {
  ...
  description: "Learn the types of tools on a site, then inspect before you use. A damaged tool comes out of service.",
  estimatedMinutes: 18,
  difficulty: "Core",
  completionXp: 500,
  jurisdiction: "CANADA",
  ...
  objectives: [
    "Name the common types of tools on a construction site and the examples that belong to each type.",
  ...
  blocks: [
    ...
    },
    {
      ...
      intro:
        "A construction site uses more than one kind of tool. Open each type and read what it is, which tools belong to it, and what stays true before anyone picks one up. Ladders and scaffolds are access equipment. They are covered in the falls module. Cranes, forklifts, and other mobile equipment need an operator’s authorization. This page does not give that.",
      types: [
        {
          id: "hand",
          name: "Hand tools",
          what: "Tools you power with your hands. No motor, no air line, and no powder load.",
          examples: "Claw hammers, sledgehammers, pry bars, wrenches, pliers, screwdrivers, utility knives, handsaws, and tin snips.",
          note: "Use the tool for the job it was made for. A wrench is not a hammer. Check the handle and the head. A split handle or a loose head takes the tool out of service.",
        },
        {
          id: "corded",
          name: "Corded power tools",
          what: "Tools with a motor that plugs into temporary power through a cord.",
          examples: "Corded drills, circular saws, reciprocating saws, and angle grinders.",
          note: "The cord, the plug, and the guard are part of the tool. A cut jacket, a missing ground pin, or a guard taken off means the tool stays down. Reading this card does not authorize you to run one.",
        },
        {
          id: "cordless",
          name: "Cordless power tools",
          what: "The same families as corded tools, with a battery pack instead of a cord.",
          examples: "Battery drills, impact drivers, and cordless circular saws.",
          note: "A missing cord is not a skipped inspection. Check the housing, the chuck or blade, the guard, and that the battery sits properly. A damaged pack is reported. It is not taped back together.",
        },
        {
          id: "pneumatic",
          name: "Pneumatic tools",
          what: "Tools driven by compressed air from a compressor and a hose.",
          examples: "Framing nailers, finish nailers, air staplers, jackhammers, and air impact wrenches.",
          note: "The hose, the fitting, and the tool are one system. A damaged hose comes out of service. Do not point a nailer at anyone. Your employer decides who may use an air tool.",
        },
        {
          id: "powder",
          name: "Powder-actuated tools",
          what: "A separate type. They drive a fastener into concrete or steel with a powder load. They are not ordinary drills or nailers.",
          examples: "Powder-actuated fastening tools used on concrete and steel.",
          note: "They need the training and permission your employer sets. This card does not authorize you to load or use one. If you are not authorized, leave it alone and tell a supervisor.",
        },
        {
          id: "layout",
          name: "Measuring and layout tools",
          what: "Tools that mark where the work goes. They do not cut or fasten.",
          examples: "Tape measures, spirit levels, squares, chalk lines, and laser levels.",
          note: "A bent tape or a cracked level gives a bad mark. A laser can still have an eye-safety rule on the site. Read that rule before you turn one on.",
        },
        {
          id: "handling",
          name: "Material-handling tools",
          what: "Tools and simple equipment for moving weight by hand, or with a device that has a rated load.",
          examples: "Wheelbarrows, hand trucks, pry bars, come-alongs, and chain falls.",
          note: "The rated load is the limit. A come-along or chain fall with a missing rating, a damaged hook, or a frayed sling stays down. A crane or forklift is mobile equipment, not one of these tools.",
        },
      ],
    },
    {
